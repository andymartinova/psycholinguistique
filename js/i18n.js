        ...
        const translations = {
            fr: {
                ...
                "home": {
                    ...
                    "data_consent": "Je comprends que mes résultats seront sauvegardés automatiquement",
                    "not_bilingual": "Je confirme <strong>NE PAS</strong> être bilingue en portugais et français",
                    "german_level_label": "Niveau d'allemand d'après le test :",
                    "pretest_notice_html": "Avant de commencer le test, nous vous demandons de réaliser un test de niveau en allemand suivant ce lien : <a href=\"https://strommeninc.com/language-tests/german-level-test/?utm_source=chatgpt.com\" target=\"_blank\" rel=\"noopener noreferrer\">Test Strömmen</a>.",
                    "start_button": "Commencer l'expérience",
                    "instructions_button": "Voir les instructions",
                    "analytics_button": "📊 Analyses individuelles",
                    "analytics_enhanced_button": "📈 Analyses avancées",
                ...
                "questionnaire": {
                    "title": "📝 Questionnaire optionnel",
                    "subtitle": "Aidez-nous à mieux comprendre votre profil en répondant à quelques questions optionnelles",
                    "age_label": "Âge :",
                    "age_suffix": "ans",
                    "gender_label": "Sexe :",
                    "gender_male": "Homme",
                    ...
                    "learning_duration_label": "Temps d'apprentissage de l'allemand :",
                    "select_option": "—",
                    "learning_duration_less_than_1": "Moins d'un an",
                    "learning_duration_1_to_2": "1 à 2 ans",
                    "learning_duration_2_to_5": "2 à 5 ans",
                    "learning_duration_5_to_10": "5 à 10 ans",
                    "learning_duration_more_than_10": "Plus de 10 ans",
                    "feeling_label": "Ressenti vis-à-vis de la langue allemande :",
                    "feeling_like": "J'aime bien cette langue",
                    "feeling_fear": "J'ai peur de cette langue",
                    "feeling_dislike": "Je n'aime pas cette langue",
                    "feeling_indifferent": "Je suis indifférent.e à cette langue",
                    "education_level_label": "Quel est votre niveau d'études le plus élevé validé ?",
                    "education_lycee": "Lycée",
                    "education_bac": "Bac",
                    "education_bac_plus_2": "Bac+2",
                    "education_licence": "Licence (Bac+3)",
                    "education_master": "Master",
                    "education_doctorat": "Doctorat",
                    "german_usage_frequency_label": "À quelle fréquence utilisez-vous l'allemand ?",
                    "usage_everyday": "Tous les jours",
                    "usage_several_times_week": "Plusieurs fois par semaine",
                    "usage_rarely": "Rarement",
                    "submit_button": "Voir les résultats de mon expérience",
                    "optional_note": "💡 Toutes les questions sont optionnelles. Vous pouvez passer cette étape en cliquant sur le bouton ci-dessus."
                },
                "results": {
                    "title": "📊 Résultats",
            ...
            pt: {
                ...
                "home": {
                    ...
                    "data_consent": "Entendo que meus resultados serão salvos automaticamente",
                    "not_bilingual": "Confirmo que <strong>NÃO SOU</strong> bilíngue em português e francês",
                    "german_level_label": "Nível de alemão segundo o teste:",
                    "pretest_notice_html": "Antes de começar o teste, pedimos que você realize um teste de nível em alemão seguindo este link: <a href=\"https://strommeninc.com/language-tests/german-level-test/?utm_source=chatgpt.com\" target=\"_blank\" rel=\"noopener noreferrer\">Teste Strömmen</a>.",
                    "start_button": "Iniciar experimento",
                    "instructions_button": "Ver instruções",
                    "analytics_button": "📊 Análises",
                    "analytics_enhanced_button": "📈 Análises avançadas",
                ...
                "questionnaire": {
                    "title": "📝 Questionário opcional",
                    "subtitle": "Ajude-nos a entender melhor seu perfil respondendo a algumas perguntas opcionais",
                    "age_label": "Idade:",
                    "age_suffix": "anos",
                    "gender_label": "Sexo:",
                    "gender_male": "Homem",
                    ...
                    "gender_other": "Outro",
                    "gender_prefer_not_to_say": "Prefiro não responder",
                    "learning_duration_label": "Tempo de aprendizado de alemão:",
                    "select_option": "—",
                    "learning_duration_less_than_1": "Menos de um ano",
                    "learning_duration_1_to_2": "1 a 2 anos",
                    "learning_duration_2_to_5": "2 a 5 anos",
                    "learning_duration_5_to_10": "5 a 10 anos",
                    "learning_duration_more_than_10": "Mais de 10 anos",
                    "feeling_label": "Sentimento em relação à língua alemã:",
                    "feeling_like": "Eu gosto desta língua",
                    "feeling_fear": "Tenho medo desta língua",
                    "feeling_dislike": "Não gosto desta língua",
                    "feeling_indifferent": "Sou indiferente a esta língua",
                    "education_level_label": "Qual é o seu nível de estudos mais elevado validado?",
                    "education_lycee": "Ensino Médio",
                    "education_bac": "Bacharelado",
                    "education_bac_plus_2": "Bacharelado+2",
                    "education_licence": "Licenciatura (Bacharelado+3)",
                    "education_master": "Mestrado",
                    "education_doctorat": "Doutorado",
                    "german_usage_frequency_label": "Com que frequência você usa o alemão?",
                    "usage_everyday": "Todos os dias",
                    "usage_several_times_week": "Várias vezes por semana",
                    "usage_rarely": "Raramente",
                    "submit_button": "Ver os resultados da minha experiência",
                    "optional_note": "💡 Todas as perguntas são opcionais. Você pode pular esta etapa clicando no botão acima."
                },
                "results": {
                    "title": "📊 Resultados",
